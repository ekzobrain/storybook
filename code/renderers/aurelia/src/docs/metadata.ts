...
import type { AssignmentExpression, MemberExpression, Literal, Identifier, Comment } from 'estree';
import { CustomElement, Metadata } from 'aurelia';
...
export const getPropertyType = (
  ...
  const metadata = Metadata.get('design:type', component.prototype, property);

  let type: SBType['name'] | undefined;
  switch (metadata) {
    case String:
    case Boolean:
    case Number:
